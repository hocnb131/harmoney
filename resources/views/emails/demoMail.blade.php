                            ...
                            <tbody>
                                <tr>
                                    <td class="esd-stripe" esd-custom-block-id="1735" align="center">
                                        <table class="es-header-body" style="background-color: #fef5e4;" width="600"
                                            cellspacing="0" cellpadding="0" bgcolor="#fef5e4" align="center">
                                            <tbody>
                                                <tr>
                                                    <td class="esd-structure es-p5t es-p5b es-p15r es-p15l"
                                                        align="center">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image es-m-p0l es-p15l es-m-txt-c"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            href="home"
                                                                                            target="_blank"><img
                                                                                                src="https://i.ibb.co/L8dst3C/aa1aef22039ec1c0988f.jpg"
                                                                                                alt="aa1aef22039ec1c0988f"
                                                                                                alt="Petshop logo"
                                                                                                title="Petshop logo"
                                                                                                width="118"></a></td>
                                                                                </tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p5t es-p5b es-p40r es-p40l"
                                                                                        align="center">
                                                                                        <p style="color: #333333;">Xác
                                                                                            nhận đặt phòng đã được gửi
                                                                                            tới 
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-button es-p15t es-p10b"
                                                                                        align="center"><span
                                                                                            class="es-button-border"
                                                                                            style="border-radius: 5px; background: #d48344 none repeat scroll 0% 0%; border-style: solid; border-color: #2cb543; border-top: 0px solid #2cb543; border-bottom: 0px solid #2cb543;"><a
                                                                                                href="ticket"
                                                                                                class="es-button"
                                                                                                target="_blank"
                                                                                                style="font-size: 16px; border-top-width: 10px; border-bottom-width: 10px; border-radius: 5px; background: #d48344 none repeat scroll 0% 0%; border-color: #d48344;">Kiểm
                                                                                                tra thông tin</a></span>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                                    ...
                                                                                    <td class="esd-block-text es-p20b es-p20r es-p20l"
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">Mã
                                                                                                            booking:</span>
                                                                                                    </td>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">945645546</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">Ngày
                                                                                                            đặt:</span>
                                                                                                    </td>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">Oct
                                                                                                            21,
                                                                                                            2017</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">Tổng:</span>
                                                                                                    </td>
                                                                                                    <td><span
                                                                                                            style="font-size: 14px; line-height: 150%;">80.67
                                                                                                            VNĐ</span>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                    ...
                                                                                    <td class="esd-block-text"
                                                                                        ...
                                                                                        <table style="width: 100%;"
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td><span
                                                                                                            style="font-size:13px;">PHÒNG</span>
                                                                                                    </td>
                                                                                                    <td style="text-align: center;"
                                                                                                        width="60">
                                                                                                        <span
                                                                                                            style="font-size:13px;"><span
                                                                                                                style="line-height: 100%;">SỐ
                                                                                                                NGƯỜI</span></span>
                                                                                                    </td>
                                                                                                    <td style="text-align: center;"
                                                                                                        width="100">
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-image"
                                                                                        ...
                                                                                        style="font-size:0"><a
                                                                                            href="ticket"
                                                                                            target="_blank"><img
                                                                                                src="https://tlr.stripocdn.email/content/guids/CABINET_075cee78891ca18b1516e76ce7e767a0/images/78761502968147773.jpg"
                                                                ...
                                                                <tr>
                                                                    <td class="esd-block-image" align="center"
                                                                        style="font-size:0"><a
                                                                            ...
                                                                            target="_blank"><img
                                                                                src="https://tlr.stripocdn.email/content/guids/CABINET_075cee78891ca18b1516e76ce7e767a0/images/22621502873981861.jpg"
                                                                                alt="Natural Balance L.I.D., sale 30%"
                                                                                class="adapt-img"
                                                                                title="Natural Balance L.I.D., sale 30%"
                                                                                width="95"></a></td>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-block-text" align="left">
                                                                        ...
                                                                        <table style="width: 100%;"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>Blue Buffalo Chicken & Brown
                                                                                        Rice</td>
                                                                                    <td style="text-align: center;"
                                                                                        width="60">1</td>
                                                                                    <td style="text-align: center;"
                                                                                        width="100">18.00 VNĐ</td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                        <p><br></p>
                                                    ...
                                                    <td class="esd-container-frame" width="560" valign="top"
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-block-spacer es-p10b"
                                                                        align="center" style="font-size:0">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td class="esd-block-image es-m-p0l es-m-txt-c"
                                                                        align="left" style="font-size:0"><a href
                                                                            target="_blank"><img
                                                                                src="https://i.ibb.co/L8dst3C/aa1aef22039ec1c0988f.jpg"
                                                                                alt="aa1aef22039ec1c0988f"
                                                                                alt="Petshop logo"
                                                                ...
                                                                <tr>
                                                                    <td class="esd-block-text es-p5t es-m-txt-c"
                                                                        align="left">
                                                                        <p><a target="_blank"
                                                                                href="tel:123456789">Điện
                                                                                thoại</a><br><a target="_blank"
                                                                                href="mailto:your@mail.com">Email</a>
                                                                        </p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="esd-block-text es-p15t es-p20b es-m-txt-c"
                                                                        ...
                                                                        <p style="line-height: 150%;"><span
                                                                                style="font-size: 20px; line-height: 150%;">Xác
                                                                                nhận đơn đặt phòng</span></p>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td class="esd-block-text es-m-txt-c"
                                                                        align="left">
                                                                        <p>Đơn đặt phòng đã chính xác ?<a
                                                                                target="_blank"
                                                                                href="#">Không</a></p>
                                                                        <p>Bạn luôn có thể xem và thay đổi đặt phòng
                                                                            trực tuyến<br></p>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
