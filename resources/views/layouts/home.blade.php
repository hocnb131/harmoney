...
<body>
    ...
    <div id="page">
                ...
                <div class="container">
                    <div class="d-flex header-menu">
                        <div class="col-md-4 desktop">
                            <div class="left">
                                <a href="tel:1900 1833" id="hotline"><img src="{{url('/css')}}/images/hotline.svg" alt="">1900 9099</a>
                                <a href="https://www.facebook.com/fan.muongthanh" id="fb"><img src="{{url('/css')}}/images/facebook.svg" alt=""></a>
                                <a href="https://www.instagram.com/muongthanh.hospitality/" id="insta"><img src="{{url('/css')}}/images/instagram.svg" alt=""></a>
                                <a href="https://www.youtube.com/channel/UC5o0Ixg2ppx0bv3oLWBCDLQ" id="yt"><img src="{{url('/css')}}/images/youtube.svg" alt=""></a>
                            </div>
                        </div>
                            ...
                            <div class="center">
                                ...
                                <a class="mobile">
                                    <svg width="40" height="40" viewbox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <path d="M26 26.75V25.25C26 24.4544 25.6839 23.6913 25.1213 23.1287C24.5587 22.5661 23.7956 22.25 23 22.25H17C16.2044 22.25 15.4413 22.5661 14.8787 23.1287C14.3161 23.6913 14 24.4544 14 25.25V26.75" stroke="#3C3C3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M20 19.25C21.6569 19.25 23 17.9069 23 16.25C23 14.5931 21.6569 13.25 20 13.25C18.3431 13.25 17 14.5931 17 16.25C17 17.9069 18.3431 19.25 20 19.25Z" stroke="#3C3C3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                                    </svg>
                                </a>
                            </div>
                        </div>
                        <div class="col-md-4 desktop">
                            <div class="right">
                                ...
                                <div class="language">
                                    <div class="dropdown">
                                        <a class="btn-lang" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                            <img src="{{url('/css')}}/images/language_vn.svg" alt="">
                                            <i class="fa fa-language"></i>
                                        </a>
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li><a class="dropdown-item" href="{{ route('trangchu') }}">Vi</a></li>
                                ...
                                <div class="DN-DK">
                                    @guest
                                    @if (Route::has('login'))
                                    <a class="" href="{{ route('login') }}" id="dang-nhap">Đăng nhập</a>
                                    @endif
                                    @if (Route::has('register'))
                                    <a class="" href="{{ route('register') }}" id="dang-ky">Đăng ký</a>
                                    @endif
                                    @else
        ...
        <div class="block-home-search-banner">
            <div class="banner-pc slide-banner owl-carousel owl-theme">
                <div class="item">
                    <img src="{{url('/css')}}/images/banners/original/slide-3_1650352515.jpg" alt="https://booking.muongthanh.com/Khuyến mãi đỉnh nhất trong năm" class="img-responsive banner-image">
                ...
                <div class="item">
                    <img src="{{url('/css')}}/images/banners/original/property-1variant2_1650357381.jpg" alt="https://booking.muongthanh.com/Khuyến mãi đỉnh nhất trong năm" class="img-responsive banner-image">
                    <div class="content-absolute">
                        <div class="container">
                            <!-- <p class="title"></p> -->
                            <div class="content">
                ...
                <div class="wrap-form">
                    ...
                    <a href="javascript:void(0)" class="close-form block-book-btn">
                        <svg width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.1428 0.856934L0.857117 11.1426" stroke="#3C3C3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                            <path d="M0.857117 0.856934L11.1428 11.1426" stroke="#3C3C3B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path>
                        </svg>
                    </a>
                </div>
                <div class="container">
                    <form action="https://booking.muongthanh.com/booking/hotel" target="_blank" method="get" id="frmSearchBooking" name="frmSearchBooking">
                        <div class="search">
                            <div class="input">
                                ...
                                <div class="select-location">
                                    <ul class="list-search d-none" id="list-block-search">
                                        ...
                                        <li class="rs">
                                            <a href="javascript:void(0)" title-city="" alias-city="" data-title="Hà Nội" data-alias="ha noi" data-id="{{$p->id}}" data-hotel="">
                                                <i class="fas fa-map-marker-alt"></i>
                                                {{$p->name}} </a>
                                        </li>
                                        @endforeach
                                    </ul>
                                    <input type="text" autocomplete="off" id="location_search" placeholder="Nhập Khách sạn / Điểm đến" class="form-control" value="">
                                    <input type="hidden" id="location" name="location" value="" placeholder="Nhập Khách sạn / Điểm đến" class="form-control">
                            ...
                            <div class="input">
                                ...
                                <input type="hidden" name="checkin" id="checkin" data-date="01/08/2022" value="2022-08-01">
                                <input type="hidden" name="checkout" id="checkout" data-date="02/08/2022" value="2022-08-02">
                            </div>
                            <div class="input">
                                <h2>Số phòng</h2>
                                <div class="dropdown">
                                    <a class="drop-btn" id="dropSearchSelect" data-bs-toggle="dropdown" aria-expanded="false">
                                        <p class="txt">
                                            <span name="search_room" id="search_room"></span> Phòng
                                        </p>
                                    </a>
                            ...
                            <div class="input">
                                ...
                                <input class="form-control" type="text" name="voucher" id="voucher" placeholder="Nhập mã khuyến mại/mã Voucher" value="">
                            </div>
                            <div class="button">
                                <a href="" id="search_book">Tìm kiếm</a>
                            </div>
                        </div>
                    </form>
                </div>
                    ...
                    <div class="main-block">
                            ...
                            <div class="form-search">
                                <span class="check-in-out">
                                    <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M12.6667 2.6665H3.33333C2.59695 2.6665 2 3.26346 2 3.99984V13.3332C2 14.0696 2.59695 14.6665 3.33333 14.6665H12.6667C13.403 14.6665 14 14.0696 14 13.3332V3.99984C14 3.26346 13.403 2.6665 12.6667 2.6665Z" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M10.6667 1.3335V4.00016" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                                        </path>
                                        <path d="M5.33333 1.3335V4.00016" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                                        </path>
                                        <path d="M2 6.6665H14" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                                        </path>
                                    </svg>
                                    01/01/1970 -
                                    01/01/1970 </span>
                                <span class="room">
                                    <svg width="16" height="16" viewbox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M2 6.00016L8 1.3335L14 6.00016V13.3335C14 13.6871 13.8595 14.0263 13.6095 14.2763C13.3594 14.5264 13.0203 14.6668 12.6667 14.6668H3.33333C2.97971 14.6668 2.64057 14.5264 2.39052 14.2763C2.14048 14.0263 2 13.6871 2 13.3335V6.00016Z" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"></path>
                                        <path d="M6 14.6667V8H10V14.6667" stroke="white" stroke-opacity="0.87" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round">
                                        </path>
                                    </svg>
                                    phòng </span>
                            </div>
                        ...
                        <div class="icon">
                            <svg width="32" height="32" viewbox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14.6667 25.3333C20.5577 25.3333 25.3333 20.5577 25.3333 14.6667C25.3333 8.77563 20.5577 4 14.6667 4C8.77563 4 4 8.77563 4 14.6667C4 20.5577 8.77563 25.3333 14.6667 25.3333Z" stroke="#F2A900" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                                <path d="M28 28.0002L22.2 22.2002" stroke="#F2A900" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
                            </svg>
                        </div>
                    </div>
                </div>
                ...
                <div class="footer-top">
                    <div class="top-left">
                        ...
                        <form class="contact-email-form input" method="post" action="index.php?module=contact&view=contact&task=save_email">
                            ...
                            <input required="" id="email-contact" type="email" name="email-contact" placeholder="Email đăng ký nhận bản tin khuyến mãi...">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="d-flex flex-column-reverse flex-md-row justify-content-center align-items-center">
                        ...
                        <div class="col-md-5">
                            <div class="right">
                                <a href="https://www.facebook.com/fan.muongthanh" id="fb"><img src="{{url('/css')}}/images/facebook-trang.svg" alt="Facebook"></a>
                                <a href="https://www.instagram.com/muongthanh.hospitality/" id="instagram"><img src="{{url('/css')}}/images/instagram-trang.svg" alt="instagram"></a>
                                <a href="https://www.youtube.com/channel/UC5o0Ixg2ppx0bv3oLWBCDLQ" id="youtube"><img src="{{url('/css')}}/images/youtube-trang.svg" alt="youtube"></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <nav id="sideMenuMobile">
            <div class='mainmenu mainmenu-megamenu_moblie  not_home'>
                ...
                <ul id="navmenu-v2" class="ul-header">
                    ...
                    <li class="li_header  level0 first-item menu-item"><a class="a_nav" href="diem-den.htm" data-target="#">Điểm đến</a></li>
                    <li class="li_header  level0 menu-item"><a class="a_nav" href="uu-dai.htm" data-target="#">Ưu
                            đãi</a></li>
                    <li class="li_header  level0 last-item"><a class="a_nav" href="combo-gia-tot.htm" data-target="#">Combo</a></li>
                    ...
                    <button type="button" class="btn-close" data-dismiss="modal" aria-label="Close">
                        <svg fill="#fff" xmlns="http://www.w3.org/2000/svg" width="47.999" height="47.999" viewbox="0 0 47.999 47.999">
                            <g transform="translate(0 -0.001)">
                                <g transform="translate(0 0.001)">
                                    <path d="M26.651,24,47.45,3.2A1.875,1.875,0,1,0,44.8.55L24,21.349,3.2.55A1.875,1.875,0,0,0,.549,3.2L21.348,24,.549,44.8A1.875,1.875,0,0,0,3.2,47.451L24,26.652l20.8,20.8A1.875,1.875,0,0,0,47.45,44.8Z" transform="translate(0 -0.001)"></path>
                                </g>
                            </g>
                        </svg>
                    </button>
                    <div class="banner">
                        <img src="https://booking.muongthanh.com/{{url('/css')}}/images/config/group-670_1645871298.jpg" alt="" class="img-responsive">
                    </div>
                    <div class="main">
                            ...
                            <a href="login-face.htm" class="log-facebook log-social" title="Facebook Login">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="11.571" height="22.286" viewbox="0 0 11.571 22.286">
                                        <path d="M12.844-20.411a26.245,26.245,0,0,0-3.054-.161c-3.027,0-5.1,1.848-5.1,5.237v2.92H1.272v3.964H4.688V1.714h4.1V-8.451h3.4l.522-3.964H8.786v-2.531c0-1.138.308-1.929,1.955-1.929h2.1Z" transform="translate(-1.272 20.571)" fill="#1877f2"></path>
                                    </svg>
                                </span>
                                Facebook </a>
                        </div>
    ...
    <div class="wrap-loading">
        ...
        <img class="logo-loading" style="width: 100px; height: 100px; transform: translateY(-145px)" src="{{url('/css')}}/images/config/logo_1650360911.svg" alt="">
    </div>
    <div class="scrollToTop">
        <svg width="21" height="12" viewbox="0 0 21 12" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M20.449 10.0246C20.449 9.86384 20.3687 9.68304 20.2481 9.5625L10.8865 0.200893C10.766 0.0803567 10.5852 0 10.4245 0C10.2637 0 10.0829 0.0803567 9.9624 0.200893L0.600795 9.5625C0.480259 9.68304 0.399902 9.86384 0.399902 10.0246C0.399902 10.1853 0.480259 10.3661 0.600795 10.4866L1.60526 11.4911C1.7258 11.6116 1.9066 11.692 2.06731 11.692C2.22803 11.692 2.40883 11.6116 2.52937 11.4911L10.4245 3.59598L18.3195 11.4911C18.4401 11.6116 18.6209 11.692 18.7816 11.692C18.9624 11.692 19.1231 11.6116 19.2437 11.4911L20.2481 10.4866C20.3687 10.3661 20.449 10.1853 20.449 10.0246Z" fill="white"></path>
        </svg>
    </div>
