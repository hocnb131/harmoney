    ...
    <div class="row">
        <div class="col-md-9">
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name" value="{{$room->name}}" placeholder="Input name">
                @error('name')
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="adults" value="{{$room->adults}}" placeholder="Input name">
                @error('adults')
                <small class="help-block">{{message}}</small>
                @enderror
            </div>
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="childrens" value="{{$room->children}}" placeholder="Input name">
                @error('children')
                <small class="help-block">{{message}}</small>
                @enderror
            </div>
            <div class="form-group">
                ...
                <textarea name="description" class="form-control" value="{{$room->description}}" id="content" placeholder="Input description"></textarea>
